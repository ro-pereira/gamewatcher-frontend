                ...
                <TableCell align="center"  sx={cellSx}>
                  ...
                  >
                    <Box sx={{width: "40%", ...flexColumnCenter}}>
                      ...
                      <Image src={game.team_1_img} alt={`emblema do ${game.team_1_name}`} height={40} width={40} />
                    </Box>
                    ...
                    <Box sx={{width: "40%", ...flexColumnCenter}}>
                      ...
                      <Image src={game.team_2_img} alt={`emblema do ${game.team_2_name}`} height={40} width={40} />
